...
describe('input-validation middleware tests', function () {
    ...
    servers.forEach(server => {
        describe(`Simple server - no options ${server.framework}`, function () {
            var app;
            before(function () {
                return require(`./${server.framework}/test-simple-server`).then(function (testServer) {
                    app = testServer;
                });
            });
            beforeEach(function (){
        ...
        describe(`Simple server - type coercion enabled ${server.framework}`, function () {
            var app;
            before(function () {
                return require(`./${server.framework}/test-simple-server-with-coercion`).then(function (testServer) {
                    app = testServer;
                });
            });
            beforeEach(function (){
        ...
        describe(`Simple server - with base path ${server.framework}`, function () {
            var app;
            before(function () {
                return require(`./${server.framework}/test-simple-server-with-base-path`).then(function (testServer) {
                    app = testServer;
                });
            });
            beforeEach(function (){
        ...
        describe(`Simple server using routes ${server.framework}`, function () {
            var app;
            before(function () {
                return require(`./${server.framework}/test-simple-server-base-route`).then(function (testServer) {
                    app = testServer;
                });
            });
            beforeEach(function (){
        ...
        describe(`Server with options - beautify and one error ${server.framework}`, function () {
            var app;
            before(function () {
                return require(`./${server.framework}/test-server-with-options`).then(function (testServer) {
                    app = testServer;
                });
            });
            beforeEach(function (){
        ...
        describe(`Server with options - Only beautify errors ${server.framework}`, function () {
            var app;
            before(function () {
                return require(`./${server.framework}/test-server-with-options-more-than-1-error`).then(function (testServer) {
                    app = testServer;
                });
            });
            beforeEach(function (){
        ...
        describe(`Inheritance ${server.framework}`, function () {
            var app;
            before(function () {
                return require(`./${server.framework}/test-server-inheritance`).then(function (testServer) {
                    app = testServer;
                });
            });
            beforeEach(function (){
        ...
        describe(`FormData ${server.framework}`, function () {
            var app;
            before(function () {
                return require(`./${server.framework}/test-server-formdata`).then(function (testServer) {
                    app = testServer;
                });
            });
            beforeEach(function (){
